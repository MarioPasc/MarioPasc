...
**Technical Expertise:**
Python, PyTorch, MONAI, PyTorch-Lightning, Scikit-Image, Scikit-Learn

**Academic Objectives:**
Pursuing doctoral studies in Artificial Intelligence, ideally, applied to Biomedical Imaging with a focus on Diffusion approaches and representation learning.
...
|---------|-------------|--------------|
| [**Shared Latent Image-Mask Diffusion**](https://github.com/MarioPasc/slim-diff) | A compact joint diffusion model for synthesizing paired FLAIR MRI slices and lesion masks in low-data epilepsy imaging scenarios. | PyTorch, MONAI-Generative |
